...
public class PipelineDefinitionJsonParser {
    ...
    public static PipelineDefinition parse(String config) {
    ...
    private static PipelineDefinition parse(Map<String, Object> configMap) {
        ...
        Boolean stopOnFailure = JsonUtils.getBoolean(configMap, "stopOnFailure", false);
